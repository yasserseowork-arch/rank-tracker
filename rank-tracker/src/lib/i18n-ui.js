...
(function (global) {
  ...
  const STR = {
    ar: {
      ...
      statChecked: 'كلمات اتفحصت', statFound: 'ظهور الموقع', statAvg: 'متوسط الترتيب', statCaptcha: 'كابتشا اتحلت',
      chartTitle: 'منحنى الترتيب', chartEmpty: 'لسه مفيش بيانات — ابدأ الفحص وشوف المنحنى.',
      targetTitle: '🎯 بيانات موقعك', lblDomain: 'دومين الموقع', lblName: 'اسم الموقع بالعربي (إن وُجد)', lblNameEn: 'اسم الموقع بالإنجليزي (إن وُجد)', lblMatch: 'طريقة المطابقة',
      matchBoth: 'الدومين بالظبط (والاسم لو مفيش دومين)', matchDomain: 'الدومين بس', matchName: 'الاسم بس',
      ...
      errNoTarget: 'اكتب دومين الموقع أو اسمه (عربي/إنجليزي) الأول.', errNoKeywords: 'ضيف كلمات مفتاحية الأول.',
    ...
    en: {
      ...
      statChecked: 'Checked', statFound: 'Site found', statAvg: 'Avg position', statCaptcha: 'Captchas solved',
      chartTitle: 'Position trend', chartEmpty: 'No data yet — start a run to see the trend.',
      targetTitle: '🎯 Your site data', lblDomain: 'Site domain', lblName: 'Site name (Arabic, if any)', lblNameEn: 'Site name (English, if any)', lblMatch: 'Match mode',
      matchBoth: 'Domain exact (name only if no domain)', matchDomain: 'Domain only', matchName: 'Name only',
      ...
      errNoTarget: 'Set the site domain or name first.', errNoKeywords: 'Add keywords first.',
